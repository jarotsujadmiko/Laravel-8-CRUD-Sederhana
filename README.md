...
3. Install package" yang dibutuhkan laravel dengan cara => composer install
5. Membuat generate key dengan cara => php artisan key:generate
7. Membuat database sesuai nama database di konfigurasi file .env
8. melakukan migrasi database dengan cara => php artisan migrate
9.halooo
